...
A simple full-stack CRUD application where users can create, view, update, and delete flashcards.

The app uses **React (frontend)**, **Express (backend)**, and **MongoDB (database)** for persistent storage.
